...
const Credits = () => {
  ...
  return (
    <div className="flex flex-col md:justify-center items-center h-screen overflow-y-auto w-full">
      ...
      <div className="grid md:grid-cols-3 md:gap-8 gap-5 md:my-12 py-5">
        {
