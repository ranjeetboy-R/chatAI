    ...
    <div>
      {
        message.role === 'user' ?
          <div className="flex items-start justify-end my-4 gap-2">
            <div className="flex flex-col py-2 px-3 bg-blue-200 shadow-[3px_3px_5px_rgba(0,0,0,0.3)] dark:bg-violet-600/20 border border-[#80609F]/30 rounded-xl max-w-2xl ">
